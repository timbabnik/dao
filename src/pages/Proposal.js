...
const Proposal = () => {
  ...
  async function castVote(upDown) {
    ...
    let options = {
      ...
      abi: [
        {"inputs":[{"internalType":"uint256","name":"_id","type":"uint256"},{"internalType":"bool","name":"_vote","type":"bool"}],"name":"voteOnProposal","outputs":[],"stateMutability":"nonpayable","type":"function"},
      ],
      params: {
    ...
    <>
      <div className="contentProposal">
        <div className="proposal">
          ...
          <div style={{ width: 650, padding: 10, borderRadius: 10, fontSize: 50}}>{proposalDetails.description}</div>
          <div className="proposalOverview">
            <Tag color={proposalDetails.color} text={proposalDetails.text} />
            <div className="proposer">
              <span style={{color: "lightgrey"}}>Proposed By </span>
